...
function confirmOrder(orderId, userId, pointId) {
	...
	window.location.href = "/_administrator/finish-private-order.htm?id=" + orderId + "&userId=" + userId + "&points=" + points;
}
</script>
</head>
...
<caption class="form-title">私人已确认订单列表</caption>
<tr align="center" bgcolor="#FAFAF1" height="22">
	<td width="12%">下单时间</td>
	<td width="10%">订单号</td>
	<td width="10%">厨房</td>
	<td width="13%">上课日期时间</td>
	<td width="5%">客人数</td>
	<td width="5%">总价</td>
	<td width="15%">联系人</td>
	<td width="15%">联系方式</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>
		<a href="#" onclick="confirmOrder('<s:property value="orderPrivateId"/>', '<s:property value="orderbasic.userdetail.userId"/>', 'order_<s:property value="%{#st.index}"/>')">积点确认</a> | 
