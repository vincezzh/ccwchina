...
<s:form action="news-add" namespace="/_administrator" method="post" name="form" target="_self" id="form">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
     <caption>新建咨询</caption>
    <tr>
      <td width="18%">咨询标题</td>
    ...
    <tr>
      ...
      <td><label for="name"></label>
	      <s:textfield name="news.issueDate">
	      	<s:param name="value"><s:date name="today" format="yyyy-MM-dd"/></s:param>
	      </s:textfield>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><label for="textarea"></label>
      <s:checkbox name="highlight" value="false" fieldValue="highlight"/></td>
    </tr>
    <tr>
      <td>咨询内容</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="news.newsContent" rows="10"></textarea></td>
    </tr>
    </table>
