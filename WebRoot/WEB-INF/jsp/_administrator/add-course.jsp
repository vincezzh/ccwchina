...
<s:form action="course-add" namespace="/_administrator" method="post" name="form" target="_self" id="form">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
     <caption>新建课程</caption>
    <tr>
	...
	<tr>
      <td width="18%">类别二</td>
      <td width="82%"><label for="category"></label>
        <div id="branch"><select name="course.coursebranchtype.courseBranchTypeId"><option value="-1">请选择</option></select></div>
		</td>
	</tr>
    <tr>
      <td>网络搜索关键字</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="course.courseDescriptionEn" rows="10"></textarea></td>
    </tr>
    <tr>
      <td>中文描述</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="course.courseDescriptionCn" rows="10"></textarea></td>
    </tr>
    <tr>
      <td>日文描述</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="course.courseDescriptionJp" rows="10"></textarea></td>
    </tr>
    </table>
