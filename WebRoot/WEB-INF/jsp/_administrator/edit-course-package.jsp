...
<div class="form-admin">
  <s:form action="course-package-update" namespace="/_administrator" method="post" name="form" target="_self" id="form1">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
	...
	<s:hidden name="coursePackage.coursePackageId"/>
	
  <div class="save-button">
    <input type='submit' class="coolbg np" value='更新' />
