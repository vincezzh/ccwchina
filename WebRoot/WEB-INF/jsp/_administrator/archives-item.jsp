...
<caption class="form-title">商品列表</caption>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><s:property value="itemNameCn"/></td>
	<td><s:property value="%{getText(itemtrunktype.itemTrunkTypeNameKey)}"/></td>
	<td>
		<s:a action="update-item" namespace="/_administrator">
			<s:param name="itemId"><s:property value="itemId"/></s:param>
			编辑
		</s:a> | 
		<s:a action="item-delete" namespace="/_administrator">
			<s:param name="itemId"><s:property value="itemId"/></s:param>
			删除
		</s:a>
	</td>
