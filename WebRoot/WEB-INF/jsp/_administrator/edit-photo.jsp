...
<s:form action="photo-update" namespace="/_administrator" method="post" name="form" target="_self" id="form">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
     <caption>更新照片</caption>
    <tr>
      <td width="18%">照片类别</td>
    ...
    <tr>
      ...
      <td>
	      ...
	      <span id="photoIndexPicture"><img src="<s:property value="photo.photoIndexPath"/>" width="150"/></span>
    ...
    <tr>
      ...
      <td>
	      ...
	      <span id="photoPicture"><img src="<s:property value="photo.photoPath"/>" width="150"/></span>
      </td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    ...
    <s:hidden name="photo.photoId"></s:hidden>
    <s:hidden name="photo.updatedTime"></s:hidden>
    <s:hidden name="photo.userdetail.userId"></s:hidden>
