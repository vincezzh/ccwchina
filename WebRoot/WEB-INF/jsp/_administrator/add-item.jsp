...
<s:form action="item-add" namespace="/_administrator" method="post" name="form" target="_self" id="form">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
     <caption>新建商品</caption>
    <tr>
    ...
    <tr>
      <td>上架时间</td>
      <td><label for="keywords"></label>
      <s:textfield name="startTime"/>（格式：2011-01-01）</td>
    </tr>
    <tr>
      <td>下架时间</td>
      <td><label for="keywords"></label>
      <s:textfield name="endTime"/>（格式：2011-01-01）</td>
    </tr>
    <tr>
      <td>已出售数量</td>
      <td><label for="keywords"></label>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="item.itemDescriptionEn" rows="10"></textarea></td>
    </tr>
    <tr>
      <td>中文描述</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="item.itemDescriptionCn" rows="10"></textarea></td>
    </tr>
    <tr>
      <td>日文描述</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><textarea class="ckeditor" cols="80" name="item.itemDescriptionJp" rows="10"></textarea></td>
    </tr>
    </table>
