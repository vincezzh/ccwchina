...
<s:form action="" namespace="/_administrator" method="post" name="form" target="_self" id="form">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
     <caption>私人课程订单详情</caption>
    <tr>
      <td width="18%">订单号</td>
      <td><label for="name"></label>
      <s:property value="order.orderPrivateId"/></td>
    </tr>
    <tr>
      <td width="18%">总人数</td>
      <td><label for="name"></label>
    ...
    <tr>
      <td width="18%">上课时间</td>
      <td><label for="name"></label>
      <s:date name="order.courseDate" format="yyyy-MM-dd"/> <s:property value="order.classtime.classTimeContent"/></td>
    </tr>
    <tr>
      <td width="18%">上课地点</td>
      <td><label for="name"></label>
      <s:property value="order.courselocation.courseLocationName"/></td>
    </tr>
    <tr>
      <td width="18%">上课内容</td>
      <td><label for="name"></label>
    ...
    <s:hidden name="id" value="%{order.orderPrivateId}"></s:hidden>
