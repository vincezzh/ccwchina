...
<div class="form-admin">
  <s:form action="item-category-update" namespace="/_administrator" method="post" name="form" target="_self" id="form-add-category">
  ...
  <s:hidden name="trunk.itemTrunkTypeId"></s:hidden>
