...
<title><s:text name="PRIVATE_ORDER_LIST_HISTORY"/></title>
...
<div>
	<span class="color_green bold"><s:text name="PRIVATE_COOKING_LESSONS_HISTORY"/></span>
</div>
<p/>
<table cellspacing="0" cellpadding="2" width="100%" class="font_samll_2 order_table">
    ...
    <tr>
        ...
        <td colspan="4" align="right">
        	<a href="<s:url action="private-orders" namespace="/user"/>"><s:text name="BACK"/></a>
        </td>
    </tr>
</table>
