...
<title><s:text name="ITEM_ORDER_LIST_HISTORY"/></title>
...
<div>
	<span class="color_green bold"><s:text name="ITEM_ORDER_LIST"/></span>
</div>
<p/>
<table cellspacing="0" cellpadding="2" width="100%" class="font_samll_2 order_table">
    <tr class="background_green bold">
    	<td colspan="4" align="center"><span><s:text name="ITEM_ORDER_LIST"/></span></td>
    </tr>
    <tr align="left">
    ...
    <tr>
        ...
        <td colspan="2" align="right">
        	<a href="<s:url action="item-orders" namespace="/user"/>"><s:text name="BACK"/></a>
        </td>
    </tr>
</table>
