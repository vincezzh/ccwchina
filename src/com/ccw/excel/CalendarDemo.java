...
//        Workbook wb = xlsx ? new XSSFWorkbook() : new HSSFWorkbook();
        ...
        for (int month = 0; month < 12; month++) {
            ...
            for (int j = 0; j < 6; j++) {
                ...
                for (int i = 0; i < days.length; i++) {
                    ...
                    Cell dayCell_11 = row1.createCell(i*2);
                    Cell dayCell_21 = row1.createCell(i*2 + 1);
                    Cell dayCell_12 = row2.createCell(i*2);
                    Cell dayCell_22 = row2.createCell(i*2 + 1);
                    Cell dayCell_13 = row3.createCell(i*2);
                    Cell dayCell_23 = row3.createCell(i*2 + 1);
                    ...
                    if(cnt >= day_of_week && calendar.get(Calendar.MONTH) == month) {
                        ...
                        if(i == 0 || i == days.length-1) {
                            ...
                            dayCell_2.setCellValue("[10:00-12:00]\nmust try\ncourse 1");
                        }
                    } else {
        ...
        String file = "C:\\Users\\vzhang\\Desktop\\calendar.xls";
//        if(wb instanceof XSSFWorkbook) file += "x";
    ...
    private static Map<String, CellStyle> createStyles(HSSFWorkbook wb){
    	...
    	palette.setColorAtIndex((short)63,
                (byte) java.awt.Color.decode("#cccc00").getRed(),  //RGB red (0-255)
                (byte) java.awt.Color.decode("#cccc00").getGreen(),    //RGB green
                (byte) java.awt.Color.decode("#cccc00").getBlue()     //RGB blue
        );
