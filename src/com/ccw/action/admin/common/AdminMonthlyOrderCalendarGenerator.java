...
public class AdminMonthlyOrderCalendarGenerator {
			...
			for (int i = j * 7; i < (j + 1) * 7; i++) {
				...
				if(!"".equals(days[i])) {
					...
					if(dayPublicOrders != null) {
						...
						sb.append("<div class='bold color_green'>公共课订单</div>");
						while(iPublicKeys.hasNext()) {
							...
							sb.append("<div class='bold'>" + key + "</div>");
					...
					if(dayPrivateOrders != null) {
						...
						sb.append("<div class='bold color_purple'>私人课订单</div>");
